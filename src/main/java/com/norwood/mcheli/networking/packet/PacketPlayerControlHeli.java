...
public class PacketPlayerControlHeli extends PacketPlayerControlBase {
    ...
    public final DataPlayerControlHeli controlBaseData;
    ...
    protected void handleFold(MCH_EntityAircraft aircraft, PlayerControlBaseData data) {
        var heliData = (DataPlayerControlHeli) data;
