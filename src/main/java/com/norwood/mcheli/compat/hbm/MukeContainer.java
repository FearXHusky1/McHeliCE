...
public class MukeContainer {
    ...
    public void loadRuntimeInstances() {
        runtimeAttribs = attributes.stream().map(com.hbm.explosion.ExplosionNT.ExAttrib::valueOf).collect(Collectors.toList());
    }
    ...
    public void explode(World world, double posX, double posY, double posZ,  boolean effectOnly) {
        ...
        com.hbm.explosion.ExplosionNukeSmall.explode(world, posX, posY, posZ, (com.hbm.explosion.ExplosionNukeSmall.MukeParams) type);
    }
